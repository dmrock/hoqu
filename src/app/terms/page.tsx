...
export default function TermsPage() {
  return (
    <main className="mx-auto max-w-2xl px-4 py-12">
      ...
      <h1 className="font-pixel mt-6 text-xl text-foreground">Terms of Service</h1>
      ...
      <div className="mt-8 space-y-6 text-foreground">
        ...
        <section className="space-y-2">
          ...
          <p>
            ...
            You're responsible for keeping your credentials safe and for the content you post under
            your account.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            Your items, notes, achievements, and profile are yours. Catalog metadata (titles, cover
            images, ratings) is provided by TMDB, RAWG, and Open Library and remains subject to
        ...
        <section className="space-y-2">
          ...
          <p>
            ...
            by law, the maintainer is not liable for any loss arising from your use of the service,
            including but not limited to lost data, lost points, or downtime.
          </p>
        </section>
