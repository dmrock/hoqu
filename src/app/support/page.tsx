...
// The page is reachable from both the marketing footer and the signed-in
...
/**
 * `inApp` matches whichever shell wraps it: full width like every other signed-in
 * page, or the narrow reading column the public pages (/features, /privacy,
 * /terms) share.
 */
  ...
  return (
    <article className={cn("w-full", inApp ? "" : "mx-auto max-w-2xl py-8 md:py-12")}>
      ...
      <p className="mt-4 text-base text-muted-foreground">
        ...
        and you can watch a bug move from reported to fixed.
      </p>
      ...
      <div className={cn("mt-6", inApp ? "grid gap-4 md:grid-cols-3" : "space-y-4")}>
        ...
        >
          ...
          error screen, the &quot;Report it&quot; button there carries the error code across for you
        ...
        >
          One idea per issue, with the problem it solves rather than the solution you have in mind.
          HOQU is a hobby project, so the honest answer is often &quot;not soon&quot; — but requests
        ...
        <Lane
          ...
          cta="Ask a question"
        >
          Why a show split into seasons, how XP is weighted, what a locked achievement wants, why a
          search came up empty. Search the closed issues first — the answer may already be sitting
          there.
        </Lane>
      </div>
      ...
      <div className="mt-12 rounded-xl border border-border bg-card p-6">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          ...
          instead. Account trouble, a privacy request, or anything with your personal details in it
      ...
      <p className="mt-8 text-sm text-muted-foreground">
        ...
        Nothing gets lost, though — every issue is read.
      </p>
    </article>
  );
}
...
function Lane({
  ...
  return (
    <div className="flex h-full flex-col rounded-xl border border-border bg-card p-5">
      ...
      <p className="mt-3 flex-1 text-sm leading-relaxed text-muted-foreground">{children}</p>
